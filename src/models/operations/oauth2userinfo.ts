...
export const Oauth2UserinfoResponseOauth2Userinfo$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([components.UserInfoOrganization$inboundSchema, components.UserInfoUser$inboundSchema]);
...
export namespace Oauth2UserinfoResponseOauth2Userinfo$ {
    ...
    export const inboundSchema = Oauth2UserinfoResponseOauth2Userinfo$inboundSchema;
    /** @deprecated use `Oauth2UserinfoResponseOauth2Userinfo$outboundSchema` instead. */
    export const outboundSchema = Oauth2UserinfoResponseOauth2Userinfo$outboundSchema;
