...
/** @internal */
export const RepositoriesListQueryParamOrganizationIDFilter$inboundSchema: z.ZodType<
...
/** @internal */
export const RepositoriesListQueryParamOrganizationIDFilter$outboundSchema: z.ZodType<
...
export namespace RepositoriesListQueryParamOrganizationIDFilter$ {
    ...
    export const inboundSchema = RepositoriesListQueryParamOrganizationIDFilter$inboundSchema;
    /** @deprecated use `RepositoriesListQueryParamOrganizationIDFilter$outboundSchema` instead. */
    export const outboundSchema = RepositoriesListQueryParamOrganizationIDFilter$outboundSchema;
    /** @deprecated use `RepositoriesListQueryParamOrganizationIDFilter$Outbound` instead. */
    export type Outbound = RepositoriesListQueryParamOrganizationIDFilter$Outbound;
}
...
> = z
    .object({
        ...
        external_organization_name: z
            .nullable(z.union([z.string(), z.array(z.string())]))
            .optional(),
        is_private: z.nullable(z.boolean()).optional(),
        organization_id: z.nullable(z.union([z.string(), z.array(z.string())])).optional(),
        page: z.number().int().default(1),
        limit: z.number().int().default(10),
        sorting: z.nullable(z.array(components.RepositorySortProperty$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        ...
        page: z.number().int().default(1),
        limit: z.number().int().default(10),
        sorting: z.nullable(z.array(components.RepositorySortProperty$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
