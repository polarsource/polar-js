...
export namespace Oauth2ClientsOauth2GetClientRequest$ {
    ...
    export const inboundSchema = Oauth2ClientsOauth2GetClientRequest$inboundSchema;
    /** @deprecated use `Oauth2ClientsOauth2GetClientRequest$outboundSchema` instead. */
    export const outboundSchema = Oauth2ClientsOauth2GetClientRequest$outboundSchema;
