...
/** @internal */
export const FilesListRequest$inboundSchema: z.ZodType<FilesListRequest, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const FilesListResponse$inboundSchema: z.ZodType<FilesListResponse, z.ZodTypeDef, unknown> =
    z
        .object({
