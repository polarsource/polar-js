...
export namespace Oauth2ClientsOauth2DeleteClientRequest$ {
    ...
    export const inboundSchema = Oauth2ClientsOauth2DeleteClientRequest$inboundSchema;
    /** @deprecated use `Oauth2ClientsOauth2DeleteClientRequest$outboundSchema` instead. */
    export const outboundSchema = Oauth2ClientsOauth2DeleteClientRequest$outboundSchema;
