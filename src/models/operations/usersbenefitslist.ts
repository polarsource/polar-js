...
/** @internal */
export const BenefitTypeFilter$inboundSchema: z.ZodType<BenefitTypeFilter, z.ZodTypeDef, unknown> =
...
/** @internal */
export const OrderIDFilter$inboundSchema: z.ZodType<OrderIDFilter, z.ZodTypeDef, unknown> = z.union(
...
> = z
    .object({
        ...
        sorting: z.nullable(z.array(components.UserBenefitSortProperty$inboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
