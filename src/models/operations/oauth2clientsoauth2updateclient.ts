...
export namespace Oauth2ClientsOauth2UpdateClientRequest$ {
    ...
    export const inboundSchema = Oauth2ClientsOauth2UpdateClientRequest$inboundSchema;
    /** @deprecated use `Oauth2ClientsOauth2UpdateClientRequest$outboundSchema` instead. */
    export const outboundSchema = Oauth2ClientsOauth2UpdateClientRequest$outboundSchema;
