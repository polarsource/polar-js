...
export namespace Oauth2IntrospectTokenTokenTypeHint$ {
    ...
    export const outboundSchema = Oauth2IntrospectTokenTokenTypeHint$outboundSchema;
}

/** @internal */
export const Oauth2IntrospectTokenIntrospectTokenRequest$inboundSchema: z.ZodType<
...
> = z
    .object({
        token: z.string(),
        token_type_hint: z.nullable(Oauth2IntrospectTokenTokenTypeHint$inboundSchema).optional(),
        client_id: z.string(),
...
/** @internal */
export const Oauth2IntrospectTokenIntrospectTokenRequest$outboundSchema: z.ZodType<
...
> = z
    .object({
        token: z.string(),
        tokenTypeHint: z.nullable(Oauth2IntrospectTokenTokenTypeHint$outboundSchema).optional(),
        clientId: z.string(),
...
export namespace Oauth2IntrospectTokenIntrospectTokenRequest$ {
    ...
    export const inboundSchema = Oauth2IntrospectTokenIntrospectTokenRequest$inboundSchema;
    /** @deprecated use `Oauth2IntrospectTokenIntrospectTokenRequest$outboundSchema` instead. */
    export const outboundSchema = Oauth2IntrospectTokenIntrospectTokenRequest$outboundSchema;
