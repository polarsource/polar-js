...
/** @internal */
export const UsersSubscriptionsListQueryParamOrganizationIDFilter$inboundSchema: z.ZodType<
...
/** @internal */
export const UsersSubscriptionsListQueryParamOrganizationIDFilter$outboundSchema: z.ZodType<
...
export namespace UsersSubscriptionsListQueryParamOrganizationIDFilter$ {
    ...
    export const inboundSchema = UsersSubscriptionsListQueryParamOrganizationIDFilter$inboundSchema;
    ...
    export type Outbound = UsersSubscriptionsListQueryParamOrganizationIDFilter$Outbound;
}
...
> = z
    .object({
        ...
        sorting: z
            .nullable(z.array(components.UserSubscriptionSortProperty$inboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        ...
        limit: z.number().int().default(10),
        sorting: z
            .nullable(z.array(components.UserSubscriptionSortProperty$outboundSchema))
            .optional(),
    })
    .transform((v) => {
        return remap$(v, {
