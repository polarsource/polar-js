...
export type UsersBenefitsGetResponseUsersBenefitsGet =
    ...
    | (components.BenefitGitHubRepositorySubscriber & { type: "github_repository" })
...
> = z.union([
    components.BenefitArticlesSubscriber$inboundSchema.and(
        z.object({ type: z.literal("articles") }).transform((v) => ({ type: v.type }))
    ),
...
export type UsersBenefitsGetResponseUsersBenefitsGet$Outbound =
    ...
    | (components.BenefitGitHubRepositorySubscriber$Outbound & { type: "github_repository" })
    | (components.BenefitDownloadablesSubscriber$Outbound & { type: "downloadables" })
    | (components.BenefitAdsSubscriber$Outbound & { type: "ads" })
    | (components.BenefitCustomSubscriber$Outbound & { type: "custom" })
    | (components.BenefitLicenseKeysSubscriber$Outbound & { type: "license_keys" });
...
export namespace UsersBenefitsGetResponseUsersBenefitsGet$ {
    ...
    export const inboundSchema = UsersBenefitsGetResponseUsersBenefitsGet$inboundSchema;
    /** @deprecated use `UsersBenefitsGetResponseUsersBenefitsGet$outboundSchema` instead. */
    export const outboundSchema = UsersBenefitsGetResponseUsersBenefitsGet$outboundSchema;
