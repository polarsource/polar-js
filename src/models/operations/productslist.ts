...
/** @internal */
export const ProductsListQueryParamOrganizationIDFilter$inboundSchema: z.ZodType<
...
/** @internal */
export const ProductsListQueryParamOrganizationIDFilter$outboundSchema: z.ZodType<
...
export namespace ProductsListQueryParamOrganizationIDFilter$ {
    ...
    export const inboundSchema = ProductsListQueryParamOrganizationIDFilter$inboundSchema;
    /** @deprecated use `ProductsListQueryParamOrganizationIDFilter$outboundSchema` instead. */
    export const outboundSchema = ProductsListQueryParamOrganizationIDFilter$outboundSchema;
...
/** @internal */
export type QueryParamSubscriptionTierTypeFilter$Outbound = string | Array<string>;
...
export namespace QueryParamSubscriptionTierTypeFilter$ {
    ...
    export const inboundSchema = QueryParamSubscriptionTierTypeFilter$inboundSchema;
    /** @deprecated use `QueryParamSubscriptionTierTypeFilter$outboundSchema` instead. */
    export const outboundSchema = QueryParamSubscriptionTierTypeFilter$outboundSchema;
