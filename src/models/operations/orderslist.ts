...
export namespace OrdersListQueryParamOrganizationIDFilter$ {
    ...
    export const inboundSchema = OrdersListQueryParamOrganizationIDFilter$inboundSchema;
    /** @deprecated use `OrdersListQueryParamOrganizationIDFilter$outboundSchema` instead. */
    export const outboundSchema = OrdersListQueryParamOrganizationIDFilter$outboundSchema;
...
export namespace OrdersListQueryParamProductIDFilter$ {
    ...
    export const inboundSchema = OrdersListQueryParamProductIDFilter$inboundSchema;
    /** @deprecated use `OrdersListQueryParamProductIDFilter$outboundSchema` instead. */
    export const outboundSchema = OrdersListQueryParamProductIDFilter$outboundSchema;
...
/** @internal */
export const UserIDFilter$inboundSchema: z.ZodType<UserIDFilter, z.ZodTypeDef, unknown> = z.union([
    z.string(),
    z.array(z.string()),
]);
...
/** @internal */
export const OrdersListRequest$inboundSchema: z.ZodType<OrdersListRequest, z.ZodTypeDef, unknown> =
    z
        .object({
            ...
            sorting: z.nullable(z.array(components.OrderSortProperty$inboundSchema)).optional(),
        })
        .transform((v) => {
            return remap$(v, {
...
> = z
    .object({
        ...
        page: z.number().int().default(1),
        limit: z.number().int().default(10),
        sorting: z.nullable(z.array(components.OrderSortProperty$outboundSchema)).optional(),
    })
    .transform((v) => {
        return remap$(v, {
