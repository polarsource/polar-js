...
/** @internal */
export const BenefitsListQueryParamOrganizationIDFilter$inboundSchema: z.ZodType<
...
/** @internal */
export const BenefitsListQueryParamOrganizationIDFilter$outboundSchema: z.ZodType<
...
export namespace BenefitsListQueryParamOrganizationIDFilter$ {
    ...
    export const inboundSchema = BenefitsListQueryParamOrganizationIDFilter$inboundSchema;
    /** @deprecated use `BenefitsListQueryParamOrganizationIDFilter$outboundSchema` instead. */
    export const outboundSchema = BenefitsListQueryParamOrganizationIDFilter$outboundSchema;
...
export const QueryParamBenefitTypeFilter$inboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    unknown
> = z.union([components.BenefitType$inboundSchema, z.array(components.BenefitType$inboundSchema)]);
