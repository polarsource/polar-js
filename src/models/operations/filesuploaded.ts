...
export type FilesUploadedResponseFilesUploaded =
    ...
    | (components.OrganizationAvatarFileRead & { service: "organization_avatar" });
...
export type FilesUploadedResponseFilesUploaded$Outbound =
    ...
    | (components.ProductMediaFileReadOutput$Outbound & { service: "product_media" })
    | (components.OrganizationAvatarFileRead$Outbound & { service: "organization_avatar" });
...
export namespace FilesUploadedResponseFilesUploaded$ {
    ...
    export const outboundSchema = FilesUploadedResponseFilesUploaded$outboundSchema;
