...
/** @internal */
export const WebhookSubscriptionCreatedPayloadType$inboundSchema: z.ZodNativeEnum<
    typeof WebhookSubscriptionCreatedPayloadType
> = z.nativeEnum(WebhookSubscriptionCreatedPayloadType);

/** @internal */
export const WebhookSubscriptionCreatedPayloadType$outboundSchema: z.ZodNativeEnum<
    typeof WebhookSubscriptionCreatedPayloadType
...
export namespace WebhookSubscriptionCreatedPayloadType$ {
    ...
    export const inboundSchema = WebhookSubscriptionCreatedPayloadType$inboundSchema;
    /** @deprecated use `WebhookSubscriptionCreatedPayloadType$outboundSchema` instead. */
    export const outboundSchema = WebhookSubscriptionCreatedPayloadType$outboundSchema;
}
...
export namespace WebhookSubscriptionCreatedPayload$ {
    ...
    export const outboundSchema = WebhookSubscriptionCreatedPayload$outboundSchema;
