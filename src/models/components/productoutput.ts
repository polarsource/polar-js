...
/** @internal */
export type ProductOutputBenefits$Outbound = BenefitBase$Outbound | BenefitArticles$Outbound;
...
/** @internal */
export const ProductOutput$inboundSchema: z.ZodType<ProductOutput, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
