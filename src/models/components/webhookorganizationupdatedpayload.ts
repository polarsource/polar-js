...
/** @internal */
export const WebhookOrganizationUpdatedPayloadType$inboundSchema: z.ZodNativeEnum<
    typeof WebhookOrganizationUpdatedPayloadType
> = z.nativeEnum(WebhookOrganizationUpdatedPayloadType);

/** @internal */
export const WebhookOrganizationUpdatedPayloadType$outboundSchema: z.ZodNativeEnum<
    typeof WebhookOrganizationUpdatedPayloadType
...
export namespace WebhookOrganizationUpdatedPayloadType$ {
    ...
    export const inboundSchema = WebhookOrganizationUpdatedPayloadType$inboundSchema;
    /** @deprecated use `WebhookOrganizationUpdatedPayloadType$outboundSchema` instead. */
    export const outboundSchema = WebhookOrganizationUpdatedPayloadType$outboundSchema;
}
...
export namespace WebhookOrganizationUpdatedPayload$ {
    ...
    export const outboundSchema = WebhookOrganizationUpdatedPayload$outboundSchema;
