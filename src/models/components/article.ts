...
/** @internal */
export const Article$inboundSchema: z.ZodType<Article, z.ZodTypeDef, unknown> = z
    .object({
        id: z.string(),
        slug: z.string(),
        title: z.string(),
...
/** @internal */
export const Article$outboundSchema: z.ZodType<Article$Outbound, z.ZodTypeDef, Article> = z
    .object({
        id: z.string(),
        slug: z.string(),
        title: z.string(),
        ...
        paidSubscribersOnlyEndsAt: z.nullable(z.date().transform((v) => v.toISOString())),
        isPreview: z.boolean(),
        isPinned: z.boolean(),
