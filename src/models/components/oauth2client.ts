...
/** @internal */
export const GrantTypes$inboundSchema: z.ZodNativeEnum<typeof GrantTypes> =
    z.nativeEnum(GrantTypes);
...
/** @internal */
export const ResponseTypes$inboundSchema: z.ZodNativeEnum<typeof ResponseTypes> =
    z.nativeEnum(ResponseTypes);

/** @internal */
export const ResponseTypes$outboundSchema: z.ZodNativeEnum<typeof ResponseTypes> =
...
/** @internal */
export const OAuth2Client$inboundSchema: z.ZodType<OAuth2Client, z.ZodTypeDef, unknown> = z
    .object({
        redirect_uris: z.array(z.string()),
        token_endpoint_auth_method:
            TokenEndpointAuthMethod$inboundSchema.default("client_secret_post"),
...
> = z
    .object({
        ...
        tokenEndpointAuthMethod:
            TokenEndpointAuthMethod$outboundSchema.default("client_secret_post"),
