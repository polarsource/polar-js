...
/** @internal */
export const ArticleVisibility$inboundSchema: z.ZodNativeEnum<typeof ArticleVisibility> =
    z.nativeEnum(ArticleVisibility);

/** @internal */
export const ArticleVisibility$outboundSchema: z.ZodNativeEnum<typeof ArticleVisibility> =
