...
/** @internal */
export const BenefitGitHubRepositorySubscriberType$inboundSchema: z.ZodNativeEnum<
    typeof BenefitGitHubRepositorySubscriberType
> = z.nativeEnum(BenefitGitHubRepositorySubscriberType);

/** @internal */
export const BenefitGitHubRepositorySubscriberType$outboundSchema: z.ZodNativeEnum<
    typeof BenefitGitHubRepositorySubscriberType
...
export namespace BenefitGitHubRepositorySubscriberType$ {
    ...
    export const inboundSchema = BenefitGitHubRepositorySubscriberType$inboundSchema;
    /** @deprecated use `BenefitGitHubRepositorySubscriberType$outboundSchema` instead. */
    export const outboundSchema = BenefitGitHubRepositorySubscriberType$outboundSchema;
}
...
export namespace BenefitGitHubRepositorySubscriber$ {
    ...
    export const outboundSchema = BenefitGitHubRepositorySubscriber$outboundSchema;
