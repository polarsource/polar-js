...
/** @internal */
export const Donor$inboundSchema: z.ZodType<Donor, z.ZodTypeDef, unknown> = z.union([
    DonationUser$inboundSchema,
    DonationOrganization$inboundSchema,
]);

/** @internal */
export type Donor$Outbound = DonationUser$Outbound | DonationOrganization$Outbound;

/** @internal */
export const Donor$outboundSchema: z.ZodType<Donor$Outbound, z.ZodTypeDef, Donor> = z.union([
    DonationUser$outboundSchema,
    DonationOrganization$outboundSchema,
]);
...
/** @internal */
export const DonationInput$inboundSchema: z.ZodType<DonationInput, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
