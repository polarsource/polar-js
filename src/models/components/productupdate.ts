...
export type ProductUpdate = {
     ...
     */
    prices?:
        | Array<ExistingProductPrice | ProductPriceOneTimeCreate | ProductPriceRecurringCreate>
        | null
        | undefined;
    /**
...
/** @internal */
export const Prices$inboundSchema: z.ZodType<Prices, z.ZodTypeDef, unknown> = z.union([
    ExistingProductPrice$inboundSchema,
    ProductPriceOneTimeCreate$inboundSchema,
    ProductPriceRecurringCreate$inboundSchema,
]);
...
/** @internal */
export const Prices$outboundSchema: z.ZodType<Prices$Outbound, z.ZodTypeDef, Prices> = z.union([
    ExistingProductPrice$outboundSchema,
    ProductPriceOneTimeCreate$outboundSchema,
    ProductPriceRecurringCreate$outboundSchema,
]);
...
/** @internal */
export const ProductUpdate$inboundSchema: z.ZodType<ProductUpdate, z.ZodTypeDef, unknown> = z
    .object({
