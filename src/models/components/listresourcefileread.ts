...
export type FileRead =
    ...
    | (ProductMediaFileReadOutput & { service: "product_media" });
...
/** @internal */
export const FileRead$inboundSchema: z.ZodType<FileRead, z.ZodTypeDef, unknown> = z.union([
    ...
    ProductMediaFileReadOutput$inboundSchema.and(
...
export type FileRead$Outbound =
    ...
    | (ProductMediaFileReadOutput$Outbound & { service: "product_media" });

/** @internal */
export const FileRead$outboundSchema: z.ZodType<FileRead$Outbound, z.ZodTypeDef, FileRead> =
    z.union([
        DownloadableFileRead$outboundSchema.and(
            z
                .object({ service: z.literal("downloadable") })
                .transform((v) => ({ service: v.service }))
        ),
        ...
        ProductMediaFileReadOutput$outboundSchema.and(
            z
                .object({ service: z.literal("product_media") })
                .transform((v) => ({ service: v.service }))
        ),
    ]);
