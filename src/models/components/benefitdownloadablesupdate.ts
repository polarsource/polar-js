...
> = z.object({
    ...
    properties: z.nullable(BenefitDownloadablesCreateProperties$inboundSchema).optional(),
});
...
> = z.object({
    ...
    properties: z.nullable(BenefitDownloadablesCreateProperties$outboundSchema).optional(),
});
