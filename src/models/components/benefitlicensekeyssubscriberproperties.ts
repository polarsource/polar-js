...
export namespace BenefitLicenseKeysSubscriberProperties$ {
    ...
    export const inboundSchema = BenefitLicenseKeysSubscriberProperties$inboundSchema;
    /** @deprecated use `BenefitLicenseKeysSubscriberProperties$outboundSchema` instead. */
    export const outboundSchema = BenefitLicenseKeysSubscriberProperties$outboundSchema;
