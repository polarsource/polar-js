...
/** @internal */
export const LicenseKeyStatus$inboundSchema: z.ZodNativeEnum<typeof LicenseKeyStatus> =
    z.nativeEnum(LicenseKeyStatus);

/** @internal */
export const LicenseKeyStatus$outboundSchema: z.ZodNativeEnum<typeof LicenseKeyStatus> =
