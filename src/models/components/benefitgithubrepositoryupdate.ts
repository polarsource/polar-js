...
export namespace BenefitGitHubRepositoryUpdateType$ {
    ...
    export const outboundSchema = BenefitGitHubRepositoryUpdateType$outboundSchema;
}
...
> = z.object({
    ...
    properties: z.nullable(BenefitGitHubRepositoryCreateProperties$inboundSchema).optional(),
});
...
> = z.object({
    ...
    properties: z.nullable(BenefitGitHubRepositoryCreateProperties$outboundSchema).optional(),
});
