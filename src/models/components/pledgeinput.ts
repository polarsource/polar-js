...
import { PledgeType, PledgeType$inboundSchema, PledgeType$outboundSchema } from "./pledgetype.js";
...
/** @internal */
export const PledgeInput$inboundSchema: z.ZodType<PledgeInput, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
        ...
        scheduled_payout_at: z
            ...
            .optional(),
        issue: IssueInput$inboundSchema,
...
/** @internal */
export type PledgeInput$Outbound = {
    created_at: string;
...
/** @internal */
export const PledgeInput$outboundSchema: z.ZodType<
...
> = z
    .object({
        ...
        scheduledPayoutAt: z.nullable(z.date().transform((v) => v.toISOString())).optional(),
        issue: IssueInput$outboundSchema,
 ...
 */
export namespace PledgeInput$ {
    /** @deprecated use `PledgeInput$inboundSchema` instead. */
    export const inboundSchema = PledgeInput$inboundSchema;
    /** @deprecated use `PledgeInput$outboundSchema` instead. */
    export const outboundSchema = PledgeInput$outboundSchema;
    /** @deprecated use `PledgeInput$Outbound` instead. */
    export type Outbound = PledgeInput$Outbound;
}
