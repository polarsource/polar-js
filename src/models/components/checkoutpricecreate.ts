...
export type CheckoutPriceCreateMetadata = string | number | number | boolean;
...
export type CheckoutPriceCreateCustomerMetadata =
  | string
  | number
  | number
  | boolean;
...
/** @internal */
export type CheckoutPriceCreateMetadata$Outbound =
  | string
  | number
  | number
  | boolean;
