...
> = z
    .object({
        ...
        default_upfront_split_to_contributors: z.nullable(z.number().int()).optional(),
        ...
        profile_settings: z.nullable(OrganizationProfileSettings$inboundSchema).optional(),
        feature_settings: z.nullable(OrganizationFeatureSettings$inboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        ...
        profileSettings: z.nullable(OrganizationProfileSettings$outboundSchema).optional(),
        featureSettings: z.nullable(OrganizationFeatureSettings$outboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
