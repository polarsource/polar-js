...
import { Label, Label$inboundSchema, Label$Outbound, Label$outboundSchema } from "./label.js";
import {
    Reactions,
...
/** @internal */
export const IssueInput$inboundSchema: z.ZodType<IssueInput, z.ZodTypeDef, unknown> = z
    .object({
        id: z.string(),
...
/** @internal */
export type IssueInput$Outbound = {
    id: string;
    platform: "github";
    number: number;
    title: string;
...
/** @internal */
export const IssueInput$outboundSchema: z.ZodType<IssueInput$Outbound, z.ZodTypeDef, IssueInput> = z
    .object({
        id: z.string(),
        ...
        issueClosedAt: z.nullable(z.date().transform((v) => v.toISOString())).optional(),
        issueModifiedAt: z.nullable(z.date().transform((v) => v.toISOString())).optional(),
        issueCreatedAt: z.date().transform((v) => v.toISOString()),
        needsConfirmationSolved: z.boolean(),
        confirmedSolvedAt: z.nullable(z.date().transform((v) => v.toISOString())).optional(),
 ...
 */
export namespace IssueInput$ {
    /** @deprecated use `IssueInput$inboundSchema` instead. */
    export const inboundSchema = IssueInput$inboundSchema;
    /** @deprecated use `IssueInput$outboundSchema` instead. */
    export const outboundSchema = IssueInput$outboundSchema;
    /** @deprecated use `IssueInput$Outbound` instead. */
    export type Outbound = IssueInput$Outbound;
}
