...
/** @internal */
export const FileUpload$inboundSchema: z.ZodType<FileUpload, z.ZodTypeDef, unknown> = z
    .object({
        id: z.string(),
...
/** @internal */
export const FileUpload$outboundSchema: z.ZodType<FileUpload$Outbound, z.ZodTypeDef, FileUpload> = z
    .object({
        id: z.string(),
