...
/** @internal */
export const Reactions$inboundSchema: z.ZodType<Reactions, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Reactions$outboundSchema: z.ZodType<Reactions$Outbound, z.ZodTypeDef, Reactions> = z
    .object({
