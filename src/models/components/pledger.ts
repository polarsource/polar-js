...
/** @internal */
export const Pledger$inboundSchema: z.ZodType<Pledger, z.ZodTypeDef, unknown> = z
    .object({
        name: z.string(),
...
/** @internal */
export const Pledger$outboundSchema: z.ZodType<Pledger$Outbound, z.ZodTypeDef, Pledger> = z
    .object({
        name: z.string(),
