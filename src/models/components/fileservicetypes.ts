...
/** @internal */
export const FileServiceTypes$inboundSchema: z.ZodNativeEnum<typeof FileServiceTypes> =
    z.nativeEnum(FileServiceTypes);

/** @internal */
export const FileServiceTypes$outboundSchema: z.ZodNativeEnum<typeof FileServiceTypes> =
