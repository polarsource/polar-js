...
export type DisputeCustomerTaxId = string | TaxIDFormat;
...
/** @internal */
export const DisputeCustomerTaxId$inboundSchema: z.ZodMiniType<
  DisputeCustomerTaxId,
  unknown
> = smartUnion([z.string(), TaxIDFormat$inboundSchema]);

export function disputeCustomerTaxIdFromJSON(
  jsonString: string,
): SafeParseResult<DisputeCustomerTaxId, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DisputeCustomerTaxId$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DisputeCustomerTaxId' from JSON`,
  );
}

/** @internal */
export const DisputeCustomer$inboundSchema: z.ZodMiniType<
  DisputeCustomer,
  unknown
> = z.pipe(
  z.object({
...
export function disputeCustomerFromJSON(
  jsonString: string,
): SafeParseResult<DisputeCustomer, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => DisputeCustomer$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'DisputeCustomer' from JSON`,
  );
}
