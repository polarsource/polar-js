...
export namespace BenefitDownloadablesSubscriberProperties$ {
    ...
    export const inboundSchema = BenefitDownloadablesSubscriberProperties$inboundSchema;
    /** @deprecated use `BenefitDownloadablesSubscriberProperties$outboundSchema` instead. */
    export const outboundSchema = BenefitDownloadablesSubscriberProperties$outboundSchema;
