...
/** @internal */
export const OrganizationAvatarFileCreateService$outboundSchema: z.ZodNativeEnum<
    typeof OrganizationAvatarFileCreateService
...
export namespace OrganizationAvatarFileCreateService$ {
    ...
    export const inboundSchema = OrganizationAvatarFileCreateService$inboundSchema;
    /** @deprecated use `OrganizationAvatarFileCreateService$outboundSchema` instead. */
    export const outboundSchema = OrganizationAvatarFileCreateService$outboundSchema;
}
