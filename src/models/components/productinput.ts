...
/** @internal */
export type ProductInputBenefits$Outbound = BenefitBase$Outbound | BenefitArticles$Outbound;
...
/** @internal */
export const ProductInput$inboundSchema: z.ZodType<ProductInput, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
        ...
        benefits: z.array(z.union([BenefitBase$inboundSchema, BenefitArticles$inboundSchema])),
...
> = z
    .object({
        ...
        benefits: z.array(z.union([BenefitBase$outboundSchema, BenefitArticles$outboundSchema])),
