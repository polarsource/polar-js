...
/** @internal */
export const SubscriptionStatus$inboundSchema: z.ZodNativeEnum<typeof SubscriptionStatus> =
    z.nativeEnum(SubscriptionStatus);

/** @internal */
export const SubscriptionStatus$outboundSchema: z.ZodNativeEnum<typeof SubscriptionStatus> =
