...
/** @internal */
export const RepositorySortProperty$inboundSchema: z.ZodNativeEnum<typeof RepositorySortProperty> =
    z.nativeEnum(RepositorySortProperty);

/** @internal */
export const RepositorySortProperty$outboundSchema: z.ZodNativeEnum<typeof RepositorySortProperty> =
