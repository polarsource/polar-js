 ...
 */
export type ProductMediaFileReadOutput = {
    id: string;
...
/** @internal */
export const Service$inboundSchema: z.ZodNativeEnum<typeof Service> = z.nativeEnum(Service);

/** @internal */
export const Service$outboundSchema: z.ZodNativeEnum<typeof Service> = Service$inboundSchema;
...
/** @internal */
export const ProductMediaFileReadOutput$inboundSchema: z.ZodType<
...
/** @internal */
export type ProductMediaFileReadOutput$Outbound = {
    id: string;
...
/** @internal */
export const ProductMediaFileReadOutput$outboundSchema: z.ZodType<
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ProductMediaFileReadOutput$ {
    /** @deprecated use `ProductMediaFileReadOutput$inboundSchema` instead. */
    export const inboundSchema = ProductMediaFileReadOutput$inboundSchema;
    /** @deprecated use `ProductMediaFileReadOutput$outboundSchema` instead. */
    export const outboundSchema = ProductMediaFileReadOutput$outboundSchema;
    /** @deprecated use `ProductMediaFileReadOutput$Outbound` instead. */
    export type Outbound = ProductMediaFileReadOutput$Outbound;
}
