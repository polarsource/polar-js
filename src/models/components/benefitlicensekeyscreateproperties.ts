...
> = z
    .object({
        ...
        expires: z.nullable(BenefitLicenseKeyExpirationProperties$inboundSchema).optional(),
        activations: z.nullable(BenefitLicenseKeyActivationProperties$inboundSchema).optional(),
...
> = z
    .object({
        prefix: z.nullable(z.string()).optional(),
        expires: z.nullable(BenefitLicenseKeyExpirationProperties$outboundSchema).optional(),
        activations: z.nullable(BenefitLicenseKeyActivationProperties$outboundSchema).optional(),
...
export namespace BenefitLicenseKeysCreateProperties$ {
    ...
    export const outboundSchema = BenefitLicenseKeysCreateProperties$outboundSchema;
