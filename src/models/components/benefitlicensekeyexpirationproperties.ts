...
/** @internal */
export const Timeframe$inboundSchema: z.ZodNativeEnum<typeof Timeframe> = z.nativeEnum(Timeframe);

/** @internal */
export const Timeframe$outboundSchema: z.ZodNativeEnum<typeof Timeframe> = Timeframe$inboundSchema;
...
export namespace BenefitLicenseKeyExpirationProperties$ {
    ...
    export const inboundSchema = BenefitLicenseKeyExpirationProperties$inboundSchema;
    /** @deprecated use `BenefitLicenseKeyExpirationProperties$outboundSchema` instead. */
    export const outboundSchema = BenefitLicenseKeyExpirationProperties$outboundSchema;
