...
/** @internal */
export const Benefits$inboundSchema: z.ZodType<Benefits, z.ZodTypeDef, unknown> = z.union([
    BenefitBase$inboundSchema,
    BenefitArticles$inboundSchema,
]);
...
/** @internal */
export const Benefits$outboundSchema: z.ZodType<Benefits$Outbound, z.ZodTypeDef, Benefits> =
...
/** @internal */
export const UserOrderProduct$inboundSchema: z.ZodType<UserOrderProduct, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
