...
/** @internal */
export const BenefitGitHubRepositoryCreatePropertiesPermission$inboundSchema: z.ZodNativeEnum<
    typeof BenefitGitHubRepositoryCreatePropertiesPermission
> = z.nativeEnum(BenefitGitHubRepositoryCreatePropertiesPermission);

/** @internal */
export const BenefitGitHubRepositoryCreatePropertiesPermission$outboundSchema: z.ZodNativeEnum<
    typeof BenefitGitHubRepositoryCreatePropertiesPermission
...
export namespace BenefitGitHubRepositoryCreatePropertiesPermission$ {
    ...
    export const inboundSchema = BenefitGitHubRepositoryCreatePropertiesPermission$inboundSchema;
    /** @deprecated use `BenefitGitHubRepositoryCreatePropertiesPermission$outboundSchema` instead. */
    export const outboundSchema = BenefitGitHubRepositoryCreatePropertiesPermission$outboundSchema;
}
...
export namespace BenefitGitHubRepositoryCreateProperties$ {
    ...
    export const inboundSchema = BenefitGitHubRepositoryCreateProperties$inboundSchema;
    /** @deprecated use `BenefitGitHubRepositoryCreateProperties$outboundSchema` instead. */
    export const outboundSchema = BenefitGitHubRepositoryCreateProperties$outboundSchema;
