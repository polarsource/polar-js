...
/** @internal */
export const FilePatch$inboundSchema: z.ZodType<FilePatch, z.ZodTypeDef, unknown> = z.object({
...
/** @internal */
export const FilePatch$outboundSchema: z.ZodType<FilePatch$Outbound, z.ZodTypeDef, FilePatch> =
    z.object({
        name: z.nullable(z.string()).optional(),
        version: z.nullable(z.string()).optional(),
    });
