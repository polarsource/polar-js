...
> = z.object({
    ...
    properties: z.nullable(BenefitDiscordCreateProperties$inboundSchema).optional(),
});
...
> = z.object({
    ...
    properties: z.nullable(BenefitDiscordCreateProperties$outboundSchema).optional(),
});
