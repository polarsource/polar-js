...
/** @internal */
export const OrderSortProperty$inboundSchema: z.ZodNativeEnum<typeof OrderSortProperty> =
    z.nativeEnum(OrderSortProperty);

/** @internal */
export const OrderSortProperty$outboundSchema: z.ZodNativeEnum<typeof OrderSortProperty> =
