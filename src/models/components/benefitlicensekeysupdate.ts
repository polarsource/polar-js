...
> = z.object({
    ...
    properties: z.nullable(BenefitLicenseKeysCreateProperties$inboundSchema).optional(),
});
...
> = z.object({
    ...
    properties: z.nullable(BenefitLicenseKeysCreateProperties$outboundSchema).optional(),
});
