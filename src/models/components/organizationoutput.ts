...
/** @internal */
export const OrganizationOutput$inboundSchema: z.ZodType<
  OrganizationOutput,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type OrganizationOutput$Outbound = {
  created_at: string;
...
/** @internal */
export const OrganizationOutput$outboundSchema: z.ZodType<
 ...
 */
export namespace OrganizationOutput$ {
  /** @deprecated use `OrganizationOutput$inboundSchema` instead. */
  export const inboundSchema = OrganizationOutput$inboundSchema;
  /** @deprecated use `OrganizationOutput$outboundSchema` instead. */
  export const outboundSchema = OrganizationOutput$outboundSchema;
  /** @deprecated use `OrganizationOutput$Outbound` instead. */
  export type Outbound = OrganizationOutput$Outbound;
}
