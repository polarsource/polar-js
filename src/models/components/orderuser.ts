...
/** @internal */
export const OrderUser$inboundSchema: z.ZodType<OrderUser, z.ZodTypeDef, unknown> = z
    .object({
        id: z.string(),
        email: z.string(),
...
/** @internal */
export const OrderUser$outboundSchema: z.ZodType<OrderUser$Outbound, z.ZodTypeDef, OrderUser> = z
    .object({
        id: z.string(),
        email: z.string(),
        publicName: z.string(),
