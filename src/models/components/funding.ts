...
/** @internal */
export const Funding$inboundSchema: z.ZodType<Funding, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const Funding$outboundSchema: z.ZodType<Funding$Outbound, z.ZodTypeDef, Funding> = z
    .object({
