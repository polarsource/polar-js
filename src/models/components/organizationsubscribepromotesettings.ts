...
export namespace OrganizationSubscribePromoteSettings$ {
    ...
    export const inboundSchema = OrganizationSubscribePromoteSettings$inboundSchema;
    /** @deprecated use `OrganizationSubscribePromoteSettings$outboundSchema` instead. */
    export const outboundSchema = OrganizationSubscribePromoteSettings$outboundSchema;
