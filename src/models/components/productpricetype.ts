...
/** @internal */
export const ProductPriceType$inboundSchema: z.ZodNativeEnum<typeof ProductPriceType> =
    z.nativeEnum(ProductPriceType);

/** @internal */
export const ProductPriceType$outboundSchema: z.ZodNativeEnum<typeof ProductPriceType> =
