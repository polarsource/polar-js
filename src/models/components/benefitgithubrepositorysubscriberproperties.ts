...
/** @internal */
export const BenefitGitHubRepositorySubscriberProperties$inboundSchema: z.ZodType<
...
/** @internal */
export const BenefitGitHubRepositorySubscriberProperties$outboundSchema: z.ZodType<
...
export namespace BenefitGitHubRepositorySubscriberProperties$ {
    ...
    export const inboundSchema = BenefitGitHubRepositorySubscriberProperties$inboundSchema;
    /** @deprecated use `BenefitGitHubRepositorySubscriberProperties$outboundSchema` instead. */
    export const outboundSchema = BenefitGitHubRepositorySubscriberProperties$outboundSchema;
