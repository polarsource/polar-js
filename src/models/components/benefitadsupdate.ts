...
/** @internal */
export const BenefitAdsUpdateType$inboundSchema: z.ZodNativeEnum<typeof BenefitAdsUpdateType> =
    z.nativeEnum(BenefitAdsUpdateType);

/** @internal */
export const BenefitAdsUpdateType$outboundSchema: z.ZodNativeEnum<typeof BenefitAdsUpdateType> =
...
/** @internal */
export const BenefitAdsUpdate$inboundSchema: z.ZodType<BenefitAdsUpdate, z.ZodTypeDef, unknown> =
    z.object({
