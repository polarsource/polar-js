...
/** @internal */
export const UserOrderSortProperty$inboundSchema: z.ZodNativeEnum<typeof UserOrderSortProperty> =
    z.nativeEnum(UserOrderSortProperty);

/** @internal */
export const UserOrderSortProperty$outboundSchema: z.ZodNativeEnum<typeof UserOrderSortProperty> =
