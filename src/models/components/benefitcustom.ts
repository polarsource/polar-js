...
/** @internal */
export const BenefitCustomType$inboundSchema: z.ZodNativeEnum<typeof BenefitCustomType> =
    z.nativeEnum(BenefitCustomType);

/** @internal */
export const BenefitCustomType$outboundSchema: z.ZodNativeEnum<typeof BenefitCustomType> =
...
/** @internal */
export const BenefitCustom$inboundSchema: z.ZodType<BenefitCustom, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
