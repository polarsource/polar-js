...
/** @internal */
export const BenefitArticlesType$inboundSchema: z.ZodNativeEnum<typeof BenefitArticlesType> =
    z.nativeEnum(BenefitArticlesType);

/** @internal */
export const BenefitArticlesType$outboundSchema: z.ZodNativeEnum<typeof BenefitArticlesType> =
...
/** @internal */
export const BenefitArticles$inboundSchema: z.ZodType<BenefitArticles, z.ZodTypeDef, unknown> = z
    .object({
        created_at: z
            .string()
