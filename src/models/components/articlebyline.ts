...
/** @internal */
export const ArticleByline$inboundSchema: z.ZodNativeEnum<typeof ArticleByline> =
    z.nativeEnum(ArticleByline);

/** @internal */
export const ArticleByline$outboundSchema: z.ZodNativeEnum<typeof ArticleByline> =
