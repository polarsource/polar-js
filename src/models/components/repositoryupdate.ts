...
/** @internal */
export const RepositoryUpdate$inboundSchema: z.ZodType<RepositoryUpdate, z.ZodTypeDef, unknown> = z
    .object({
        profile_settings: z.nullable(RepositoryProfileSettingsUpdate$inboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        profileSettings: z.nullable(RepositoryProfileSettingsUpdate$outboundSchema).optional(),
    })
    .transform((v) => {
        return remap$(v, {
