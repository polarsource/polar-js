 ...
 */
export type SupportCaseAttachmentFileRead = {
  /**
...
/** @internal */
export const SupportCaseAttachmentFileRead$inboundSchema: z.ZodMiniType<
...
export function supportCaseAttachmentFileReadFromJSON(
  jsonString: string,
): SafeParseResult<SupportCaseAttachmentFileRead, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => SupportCaseAttachmentFileRead$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SupportCaseAttachmentFileRead' from JSON`,
  );
}
