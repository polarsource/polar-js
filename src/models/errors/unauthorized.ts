...
/** @internal */
export const UnauthorizedType$inboundSchema: z.ZodNativeEnum<typeof UnauthorizedType> =
    z.nativeEnum(UnauthorizedType);

/** @internal */
export const UnauthorizedType$outboundSchema: z.ZodNativeEnum<typeof UnauthorizedType> =
