...
/** @internal */
export const FileNotFoundType$inboundSchema: z.ZodNativeEnum<typeof FileNotFoundType> =
    z.nativeEnum(FileNotFoundType);

/** @internal */
export const FileNotFoundType$outboundSchema: z.ZodNativeEnum<typeof FileNotFoundType> =
...
/** @internal */
export const FileNotFound$inboundSchema: z.ZodType<FileNotFound, z.ZodTypeDef, unknown> = z
    .object({
