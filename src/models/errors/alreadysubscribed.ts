...
/** @internal */
export const AlreadySubscribedType$inboundSchema: z.ZodNativeEnum<typeof AlreadySubscribedType> =
    z.nativeEnum(AlreadySubscribedType);

/** @internal */
export const AlreadySubscribedType$outboundSchema: z.ZodNativeEnum<typeof AlreadySubscribedType> =
...
/** @internal */
export const AlreadySubscribed$inboundSchema: z.ZodType<AlreadySubscribed, z.ZodTypeDef, unknown> =
    z
        .object({
