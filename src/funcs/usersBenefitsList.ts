 ...
 */
export async function usersBenefitsList(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersBenefitsListRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/users/benefits/")();
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.UsersBenefitsListResponse$inboundSchema, { key: "Result" }),
