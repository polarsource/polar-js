...
import {
  ...
  CheckoutsCustomUpdateRequest$outboundSchema,
} from "../models/operations/checkoutscustomupdate.js";
 ...
 */
export async function checkoutsCustomUpdate(
  client: PolarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CheckoutsCustomUpdateRequest$outboundSchema.parse(value),
