 ...
 */
export async function usersSubscriptionsUpdate(
    client$: PolarCore,
    ...
    Result<
        ...
        | errors.FreeSubscriptionUpgrade
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersSubscriptionsUpdateRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.UserSubscriptionUpdate, { explode: true });
    ...
    >(
        ...
        m$.jsonErr(403, errors.FreeSubscriptionUpgrade$inboundSchema),
