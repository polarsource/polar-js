 ...
 */
export async function usersSubscriptionsCreate(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.UserFreeSubscriptionCreate$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/users/subscriptions/")();
    ...
    const context = {
        operationID: "users:subscriptions:create",
        oAuth2Scopes: [],
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, components.UserSubscription$inboundSchema),
        m$.jsonErr(400, errors.AlreadySubscribed$inboundSchema),
