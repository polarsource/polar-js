 ...
 */
export function customerPortalOrdersRetryPayment(
  client: PolarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      CustomerPortalOrdersRetryPaymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/customer-portal/orders/{id}/retry-payment")(
    pathParams,
  );
