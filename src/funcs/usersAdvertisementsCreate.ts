 ...
 */
export async function usersAdvertisementsCreate(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.UserAdvertisementCampaignCreate$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, components.UserAdvertisementCampaign$inboundSchema),
