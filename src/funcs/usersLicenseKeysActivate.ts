 ...
 */
export async function usersLicenseKeysActivate(
  client: PolarCore,
  request: components.LicenseKeyActivate,
  options?: RequestOptions,
): Promise<
  Result<
    components.LicenseKeyActivationRead,
    | errors.NotPermitted
...
> {
  ...
  const path = pathToFunc("/v1/users/license-keys/activate")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.LicenseKeyActivationRead$inboundSchema),
