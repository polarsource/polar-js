 ...
 */
export async function usersAdvertisementsList(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersAdvertisementsListRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/users/advertisements/")();
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.UsersAdvertisementsListResponse$inboundSchema, { key: "Result" }),
