...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.Oauth2ClientsOauth2UpdateClientRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.OAuth2ClientConfigurationUpdate, { explode: true });
