 ...
 * Update a repository.
 */
export async function repositoriesUpdate(
  client$: PolarCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.RepositoriesUpdateRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.RepositoryUpdate, {
    explode: true,
  });
