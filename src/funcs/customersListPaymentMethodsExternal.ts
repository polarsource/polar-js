...
import {
  ...
  CustomersListPaymentMethodsExternalRequest$outboundSchema,
  CustomersListPaymentMethodsExternalResponse,
  CustomersListPaymentMethodsExternalResponse$inboundSchema,
 ...
 */
export function customersListPaymentMethodsExternal(
  client: PolarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(CustomersListPaymentMethodsExternalRequest$outboundSchema, value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CustomersListPaymentMethodsExternalResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      customersListPaymentMethodsExternal(
        client,
        {
          ...request,
          page: nextPage,
