...
import {
  ...
  BenefitsFilesRequest$outboundSchema,
  BenefitsFilesResponse,
  BenefitsFilesResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(BenefitsFilesRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/benefits/{id}/files")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, BenefitsFilesResponse$inboundSchema, { key: "Result" }),
