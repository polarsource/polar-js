 ...
 */
export async function usersSubscriptionsList(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersSubscriptionsListRequest$outboundSchema.parse(value$),
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.UsersSubscriptionsListResponse$inboundSchema, { key: "Result" }),
