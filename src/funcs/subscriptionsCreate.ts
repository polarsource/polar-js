...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.SubscriptionCreateEmail$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, components.SubscriptionOutput$inboundSchema),
