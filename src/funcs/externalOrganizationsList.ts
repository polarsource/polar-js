...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ExternalOrganizationsListRequest$outboundSchema.parse(value$),
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ExternalOrganizationsListResponse$inboundSchema, { key: "Result" }),
