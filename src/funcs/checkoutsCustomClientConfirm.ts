...
} from "../models/operations/checkoutscustomclientconfirm.js";
 ...
 */
export async function checkoutsCustomClientConfirm(
  client: PolarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => CheckoutsCustomClientConfirmRequest$outboundSchema.parse(value),
