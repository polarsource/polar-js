 ...
 * List Downloadables
 */
export async function usersDownloadablesList(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersDownloadablesListRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/users/downloadables/")();
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.UsersDownloadablesListResponse$inboundSchema, { key: "Result" }),
