 ...
 */
export async function usersAdvertisementsUpdate(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersAdvertisementsUpdateRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.UserAdvertisementCampaignUpdate, { explode: true });
