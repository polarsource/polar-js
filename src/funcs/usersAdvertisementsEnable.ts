...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersAdvertisementsEnableRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.UserAdvertisementCampaignEnable, { explode: true });
