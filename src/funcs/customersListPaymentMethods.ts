...
import {
  ...
  CustomersListPaymentMethodsRequest$outboundSchema,
  CustomersListPaymentMethodsResponse,
  CustomersListPaymentMethodsResponse$inboundSchema,
 ...
 */
export function customersListPaymentMethods(
  client: PolarCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(CustomersListPaymentMethodsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/customers/{id}/payment-methods")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, CustomersListPaymentMethodsResponse$inboundSchema, {
      key: "Result",
    }),
