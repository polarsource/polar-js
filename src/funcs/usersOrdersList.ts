 ...
 * List my orders.
 */
export async function usersOrdersList(
    client$: PolarCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UsersOrdersListRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/v1/users/orders/")();
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.UsersOrdersListResponse$inboundSchema, { key: "Result" }),
