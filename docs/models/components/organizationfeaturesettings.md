...
| `accountReviewV2Enabled`                                       | *boolean*                                                      | :heavy_minus_sign:                                             | If this organization sees the new account review checklist UI. |
| `overviewMetrics`                                              | *string*[]                                                     | :heavy_minus_sign:                                             | Ordered list of metric slugs shown on the dashboard overview.  |
| `resetProrationBehaviorEnabled`                                | *boolean*                                                      | :heavy_minus_sign:                                             | If this organization has access to reset proration behavior.   |
| `billingEnabled`                                               | *boolean*                                                      | :heavy_minus_sign:                                             | If this organization has billing enabled                       |