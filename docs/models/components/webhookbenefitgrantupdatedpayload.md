...
let value: WebhookBenefitGrantUpdatedPayload = {
  data: {
    ...
    properties: {},
    benefit: {
      createdAt: new Date("2024-07-14T15:27:37.349Z"),
      modifiedAt: new Date("2023-05-11T15:13:36.467Z"),
      id: "<value>",
      description: "unsung aw indeed blah freezing noisily as switchboard",
      selectable: false,
      deletable: false,
