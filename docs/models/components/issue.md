...
let value: Issue = {
  ...
  title: "<value>",
  state: "open",
  issueCreatedAt: new Date("2022-07-07T00:22:05.103Z"),
  needsConfirmationSolved: false,
  funding: {},
  repository: {
    id: "4eef4285-6705-4b7c-8afb-82efd115bd2a",
    isPrivate: false,
    name: "MyOrg",
    description: "tribe on quickly",
    stars: 1337,
    license: "<value>",
    homepage: "<value>",
    profileSettings: {},
    organization: {
      id: "387bdf36-6038-4e5b-8f21-f04d42cb18e6",
      name: "<value>",
      avatarUrl: "https://enchanted-thigh.info",
      isPersonal: false,
      bio: "<value>",
      prettyName: "<value>",
