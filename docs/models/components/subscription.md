  ...
  prices: [
    {
      ...
      recurringInterval: "year",
      priceCurrency: "<value>",
      minimumAmount: 168279,
      maximumAmount: 500767,
      presetAmount: 563195,
    },
  ],
  meters: [
    {
      createdAt: new Date("2023-04-20T19:01:55.296Z"),
      modifiedAt: new Date("2024-01-09T07:52:58.294Z"),
      id: "<value>",
      consumedUnits: 25,
      creditedUnits: 100,
      amount: 0,
      ...
      meter: {
        ...
        modifiedAt: new Date("2023-10-19T23:29:33.545Z"),
        id: "<value>",
        name: "<value>",
        filter: {
          conjunction: "and",
