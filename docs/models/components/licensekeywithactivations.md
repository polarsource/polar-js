...
let value: LicenseKeyWithActivations = {
  ...
  displayKey: "<value>",
  status: "revoked",
  limitActivations: 231807,
  usage: 134597,
  limitUsage: 961669,
  validations: 87979,
  lastValidatedAt: new Date("2023-08-04T14:49:09.371Z"),
  expiresAt: new Date("2022-08-10T14:04:15.423Z"),
  activations: [
    {
      id: "<value>",
      licenseKeyId: "<value>",
      label: "<value>",
      meta: {},
      createdAt: new Date("2024-08-09T15:14:51.080Z"),
      modifiedAt: new Date("2022-08-02T04:49:48.526Z"),
    },
  ],
};
```
