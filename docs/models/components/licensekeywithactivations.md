...
let value: LicenseKeyWithActivations = {
  ...
  displayKey: "<value>",
  status: "granted",
  limitActivations: 276828,
  usage: 176403,
  limitUsage: 27710,
  validations: 304361,
  lastValidatedAt: new Date("2023-07-25T19:25:22.088Z"),
  ...
  activations: [
    {
      ...
      label: "<value>",
      meta: {},
      createdAt: new Date("2023-02-19T04:09:22.349Z"),
      modifiedAt: new Date("2022-08-12T21:27:28.766Z"),
    },
  ],
};
```
