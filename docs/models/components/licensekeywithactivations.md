...
let value: LicenseKeyWithActivations = {
  ...
  displayKey: "<value>",
  status: "granted",
  limitActivations: 469498,
  usage: 518835,
  limitUsage: 882710,
  validations: 306810,
  lastValidatedAt: new Date("2023-06-20T07:08:17.746Z"),
  expiresAt: new Date("2023-09-25T23:41:23.030Z"),
  activations: [
    {
      id: "<value>",
      licenseKeyId: "<value>",
      label: "<value>",
      meta: {},
      createdAt: new Date("2023-03-31T08:46:58.589Z"),
      modifiedAt: new Date("2024-11-17T12:56:04.847Z"),
    },
  ],
};
```
