...
let value: LicenseKeyWithActivations = {
  ...
  user: {
    id: "<value>",
    email: "Carmel.Moore@yahoo.com",
    publicName: "<value>",
  },
  customer: {
    createdAt: new Date("2024-10-26T06:09:24.035Z"),
    modifiedAt: new Date("2024-10-06T17:08:38.130Z"),
    id: "<value>",
    metadata: {
      "key": 502713,
    },
    email: "Tia7@yahoo.com",
    emailVerified: false,
    name: "<value>",
    billingAddress: {
    ...
    organizationId: "<value>",
    avatarUrl: "https://tattered-jazz.name",
  },
  benefitId: "<value>",
  key: "<key>",
  displayKey: "<value>",
  status: "granted",
  limitActivations: 330422,
  usage: 287648,
  limitUsage: 45663,
  validations: 583034,
  lastValidatedAt: new Date("2024-07-12T13:06:18.566Z"),
  expiresAt: new Date("2024-04-24T06:18:14.536Z"),
  activations: [
    {
      id: "<value>",
      licenseKeyId: "<value>",
      label: "<value>",
      meta: {},
      createdAt: new Date("2022-09-28T06:11:19.187Z"),
      modifiedAt: new Date("2023-10-05T14:17:24.216Z"),
    },
  ],
};
```
