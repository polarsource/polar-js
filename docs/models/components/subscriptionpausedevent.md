...
```typescript
import { SubscriptionPausedEvent } from "@polar-sh/sdk/models/components/subscriptionpausedevent.js";

let value: SubscriptionPausedEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.paused"*                                                                                                        | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionPausedMetadata](../../models/components/subscriptionpausedmetadata.md)                                 | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |