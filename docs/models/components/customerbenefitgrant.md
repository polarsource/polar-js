...
const value: components.CustomerBenefitGrantLicenseKeys = {
  ...
  benefit: {
    id: "<value>",
    createdAt: new Date("2026-04-07T01:41:55.052Z"),
    modifiedAt: null,
    type: "license_keys",
    description:
      "unto voluntarily wherever woot nor yippee quit neatly boastfully",
    selectable: true,
    deletable: true,
    isDeleted: true,
    organizationId: "<value>",
...
```typescript
const value: components.CustomerBenefitGrantSlackSharedChannel = {
