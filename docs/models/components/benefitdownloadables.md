...
let value: BenefitDownloadables = {
  createdAt: new Date("2024-12-15T14:43:33.121Z"),
  modifiedAt: new Date("2023-10-08T15:41:56.971Z"),
  id: "<value>",
  description: "gah whoever liberalize put circumference contractor so abacus",
  selectable: false,
  deletable: false,
