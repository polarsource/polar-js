...
let value: BenefitDownloadables = {
  createdAt: new Date("2023-11-18T16:32:46.604Z"),
  modifiedAt: new Date("2023-03-31T15:00:51.435Z"),
  id: "<value>",
  description:
    "suitcase eek incidentally skeleton deselect now sidetrack dazzling",
  selectable: false,
  deletable: false,
