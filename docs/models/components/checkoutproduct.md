...
let value: CheckoutProduct = {
  ...
  benefits: [
    {
      id: "<value>",
      createdAt: new Date("2023-03-03T04:42:43.634Z"),
      modifiedAt: new Date("2023-04-20T12:52:58.852Z"),
      type: "license_keys",
      description: "reasonable pleased via",
      selectable: false,
      deletable: false,
      organizationId: "<value>",
    },
  ...
  medias: [
    {
      ...
      lastModifiedAt: new Date("2025-10-04T13:28:16.851Z"),
      version: "<value>",
      isUploaded: false,
      createdAt: new Date("2024-07-25T09:40:54.930Z"),
      sizeReadable: "<value>",
      publicUrl: "https://yellowish-costume.biz",
    },
  ],
};
```
