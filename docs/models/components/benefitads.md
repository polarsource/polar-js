...
let value: BenefitAds = {
  createdAt: new Date("2023-03-28T14:48:31.749Z"),
  modifiedAt: new Date("2022-10-12T12:54:25.552Z"),
  id: "<value>",
  description:
    "suspiciously preheat lanky politely feminize deduction sometimes",
  selectable: false,
  deletable: false,
