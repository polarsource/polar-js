...
let value: BenefitAds = {
  createdAt: new Date("2022-04-28T10:21:01.587Z"),
  modifiedAt: new Date("2023-12-30T20:01:25.846Z"),
  id: "<value>",
  description: "adolescent fooey now yawningly properly reconsideration",
  selectable: false,
  deletable: false,
