...
let value: CustomerProduct = {
  ...
  prices: [
    {
      createdAt: new Date("2023-12-17T10:05:59.361Z"),
      modifiedAt: new Date("2023-08-08T08:59:10.110Z"),
      id: "<value>",
      isArchived: false,
      productId: "<value>",
      type: "one_time",
  ...
  benefits: [
    {
      createdAt: new Date("2025-03-18T16:21:25.712Z"),
      modifiedAt: new Date("2023-08-27T11:48:36.385Z"),
      id: "<value>",
      type: "custom",
      description: "shiny lieu yellow coordination",
      selectable: false,
      deletable: false,
      organizationId: "<value>",
    },
  ...
  medias: [
    {
      ...
      lastModifiedAt: new Date("2025-10-26T06:16:40.684Z"),
      version: "<value>",
      isUploaded: false,
      createdAt: new Date("2025-01-02T03:27:45.938Z"),
      sizeReadable: "<value>",
      publicUrl: "https://darling-armoire.biz/",
    },
  ],
};
```
