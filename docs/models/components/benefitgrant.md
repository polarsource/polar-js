...
let value: BenefitGrant = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2024-08-29T23:41:53.521Z"),
  ...
  benefit: {
    id: "<value>",
    createdAt: new Date("2024-04-06T16:51:23.311Z"),
    modifiedAt: new Date("2024-02-17T13:40:06.944Z"),
    type: "meter_credit",
    description:
      "arrange upwardly supposing gah source strange lost unimpressively yowza",
    selectable: false,
    deletable: false,
    isDeleted: true,
