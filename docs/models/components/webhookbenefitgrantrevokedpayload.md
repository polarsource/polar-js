...
let value: WebhookBenefitGrantRevokedPayload = {
  data: {
    ...
    benefitId: "<value>",
    customer: {
      createdAt: new Date("2023-04-25T08:05:27.539Z"),
      modifiedAt: new Date("2024-08-26T11:17:42.321Z"),
      id: "<value>",
      metadata: {
        "key": 405335,
      },
    ...
    properties: {},
    benefit: {
      createdAt: new Date("2023-08-19T14:57:12.197Z"),
      modifiedAt: new Date("2024-09-07T18:38:25.731Z"),
      id: "<value>",
