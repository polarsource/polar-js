...
let value: BenefitLicenseKeys = {
  createdAt: new Date("2024-09-14T21:16:21.107Z"),
  modifiedAt: new Date("2024-06-07T00:39:37.430Z"),
  id: "<value>",
  description:
    "deadly silently backburn quizzically squeaky wherever short-term",
  selectable: false,
  deletable: false,
