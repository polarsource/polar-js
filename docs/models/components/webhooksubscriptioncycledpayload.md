...
```typescript
import { WebhookSubscriptionCycledPayload } from "@polar-sh/sdk/models/components/webhooksubscriptioncycledpayload.js";

let value: WebhookSubscriptionCycledPayload = {
  type: "subscription.cycled",
  timestamp: new Date("2025-08-30T02:46:16.631Z"),
  data: {
...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `type`                                                                                        | *"subscription.cycled"*                                                                       | :heavy_check_mark:                                                                            | N/A                                                                                           | subscription.cycled                                                                           |
