...
```typescript
import { SubscriptionPastDueEvent } from "@polar-sh/sdk/models/components/subscriptionpastdueevent.js";

let value: SubscriptionPastDueEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.past_due"*                                                                                                      | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionPastDueMetadata](../../models/components/subscriptionpastduemetadata.md)                               | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |