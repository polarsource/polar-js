...
let value: DiscountPercentageOnceForeverDuration = {
  ...
  name: "<value>",
  code: "<value>",
  startsAt: new Date("2024-06-08T03:51:14.602Z"),
  endsAt: new Date("2024-01-29T17:37:29.584Z"),
  maxRedemptions: 907729,
  redemptionsCount: 811865,
  organizationId: "<value>",
  products: [
    {
      createdAt: new Date("2024-10-07T06:12:11.011Z"),
      modifiedAt: new Date("2024-09-12T09:45:13.036Z"),
      id: "<value>",
      name: "<value>",
