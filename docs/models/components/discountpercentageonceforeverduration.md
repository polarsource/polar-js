...
let value: DiscountPercentageOnceForeverDuration = {
  ...
  type: "percentage",
  basisPoints: 575779,
  createdAt: new Date("2025-07-09T12:53:28.498Z"),
  modifiedAt: new Date("2023-07-12T07:15:18.514Z"),
  id: "<value>",
  metadata: {
    "key": false,
  },
  name: "<value>",
  code: "<value>",
  startsAt: new Date("2025-03-28T11:02:14.499Z"),
  endsAt: new Date("2024-01-13T00:35:57.498Z"),
  maxRedemptions: 114297,
  redemptionsCount: 742203,
