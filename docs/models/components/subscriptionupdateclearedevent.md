...
```typescript
import { SubscriptionUpdateClearedEvent } from "@polar-sh/sdk/models/components/subscriptionupdateclearedevent.js";

let value: SubscriptionUpdateClearedEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.update_cleared"*                                                                                                | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionUpdateClearedMetadata](../../models/components/subscriptionupdateclearedmetadata.md)                   | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |