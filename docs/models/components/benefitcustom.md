...
let value: BenefitCustom = {
  createdAt: new Date("2025-03-04T02:10:54.750Z"),
  modifiedAt: new Date("2023-11-13T15:24:13.369Z"),
  id: "<value>",
  description: "bah with amid aw aw opera not junior gadzooks despite",
  selectable: false,
  deletable: false,
