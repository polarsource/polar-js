...
let value: BenefitCustom = {
  createdAt: new Date("2023-05-14T13:54:35.410Z"),
  modifiedAt: new Date("2025-10-18T05:26:52.000Z"),
  id: "<value>",
  description:
    "status ah unique interestingly throughout mixture scenario why grandiose vainly",
  selectable: false,
  deletable: false,
