...
let value: LicenseKeyRead = {
  ...
  customer: {
    createdAt: new Date("2024-01-20T21:57:03.473Z"),
    modifiedAt: new Date("2024-11-04T02:39:44.261Z"),
    id: "<value>",
    metadata: {
      "key": 772726,
    },
  ...
  limitUsage: 192181,
  validations: 700751,
  lastValidatedAt: new Date("2023-05-22T10:20:56.336Z"),
  expiresAt: new Date("2022-02-06T11:47:57.029Z"),
};
```
