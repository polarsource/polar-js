...
let value: BenefitGitHubRepositorySubscriber = {
  createdAt: new Date("2023-12-13T14:22:49.263Z"),
  modifiedAt: new Date("2023-08-31T15:41:35.683Z"),
  id: "<value>",
  description: "red carelessly since humor aboard midwife unless separate",
  selectable: false,
  deletable: false,
