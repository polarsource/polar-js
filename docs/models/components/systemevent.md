...
const value: components.BenefitCycledEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2024-06-15T11:33:36.995Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
const value: components.BenefitGrantedEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2025-05-28T13:35:02.603Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
const value: components.CustomerUpdatedEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2024-07-15T17:11:37.658Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
### `components.OrderUnvoidedEvent`

```typescript
const value: components.OrderUnvoidedEvent = {
  id: "<value>",
...
const value: components.SubscriptionBillingPeriodUpdatedEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2026-08-12T14:48:28.596Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
const value: components.SubscriptionCycledEvent = {
  ...
  customer: {
    ...
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    deletedAt: null,
    firstUserEventAt: new Date("2026-06-12T11:06:25.416Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
const value: components.SubscriptionReactivatedEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2026-12-30T19:18:33.731Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
### `components.SubscriptionReinstatedEvent`

```typescript
const value: components.SubscriptionReinstatedEvent = {
  id: "<value>",
  timestamp: new Date("2026-03-16T14:52:32.270Z"),
  organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  customerId: "<value>",
  customer: {
    id: "992fae2a-2a17-4b7a-8d9e-e287cf90131b",
    createdAt: new Date("2025-12-11T15:05:39.857Z"),
    modifiedAt: new Date("2025-11-10T20:05:15.931Z"),
    metadata: {
      "key": 381115,
    },
    emailVerified: true,
    ...
    organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    deletedAt: new Date("2025-10-12T21:55:03.215Z"),
    firstUserEventAt: new Date("2026-02-21T05:09:51.762Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
const value: components.SubscriptionResumedEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2024-12-09T13:16:03.277Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
const value: components.SubscriptionRevokedEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2025-11-12T21:34:17.455Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
...
const value: components.SubscriptionUpdatedEvent = {
  ...
  customer: {
    ...
    firstUserEventAt: new Date("2026-04-28T03:52:23.837Z"),
    avatarUrl: "https://www.gravatar.com/avatar/xxx?d=404",
  },
  externalCustomerId: "<id>",
  label: "<value>",
