...
let value: CustomerSubscriptionProduct = {
  ...
  benefits: [
    {
      createdAt: new Date("2023-04-28T04:00:20.719Z"),
      modifiedAt: new Date("2025-07-16T06:48:48.904Z"),
      id: "<value>",
      type: "license_keys",
  ...
  organization: {
    ...
    pledgeMinimumAmount: 288927,
    pledgeBadgeShowAmount: false,
    defaultUpfrontSplitToContributors: 205875,
    profileSettings: {},
  },
};
```
