...
let value: WebhookBenefitGrantCreatedPayload = {
  data: {
    ...
    benefitId: "<value>",
    customer: {
      createdAt: new Date("2022-05-12T18:50:06.377Z"),
      modifiedAt: new Date("2023-07-05T08:33:29.105Z"),
      id: "<value>",
      metadata: {
        "key": "<value>",
      },
    ...
    benefit: {
      createdAt: new Date("2023-02-06T21:53:27.255Z"),
      modifiedAt: new Date("2022-02-16T14:34:47.648Z"),
      id: "<value>",
