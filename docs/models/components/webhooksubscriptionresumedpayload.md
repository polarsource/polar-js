...
```typescript
import { WebhookSubscriptionResumedPayload } from "@polar-sh/sdk/models/components/webhooksubscriptionresumedpayload.js";

let value: WebhookSubscriptionResumedPayload = {
  type: "subscription.resumed",
  timestamp: new Date("2026-02-26T00:20:20.309Z"),
  data: {
...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `type`                                                                                        | *"subscription.resumed"*                                                                      | :heavy_check_mark:                                                                            | N/A                                                                                           | subscription.resumed                                                                          |
