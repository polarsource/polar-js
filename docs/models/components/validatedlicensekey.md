...
let value: ValidatedLicenseKey = {
  ...
  customer: {
    ...
    deletedAt: new Date("2023-10-18T21:15:58.709Z"),
  ...
  displayKey: "<value>",
  status: "granted",
  limitActivations: 776832,
  usage: 496800,
  limitUsage: 113597,
  validations: 873718,
  lastValidatedAt: new Date("2024-03-09T16:25:20.394Z"),
  expiresAt: new Date("2024-10-30T03:11:08.559Z"),
};
```
