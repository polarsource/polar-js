...
let value: ValidatedLicenseKey = {
  ...
  customer: {
    ...
    deletedAt: new Date("2025-01-12T15:19:31.438Z"),
  ...
  displayKey: "<value>",
  status: "granted",
  limitActivations: 586095,
  usage: 774950,
  limitUsage: 285508,
  validations: 977011,
  lastValidatedAt: new Date("2023-05-23T18:30:24.585Z"),
  expiresAt: new Date("2024-06-03T10:10:43.292Z"),
};
```
