...
let value: ValidatedLicenseKey = {
  ...
  displayKey: "<value>",
  status: "granted",
  limitActivations: 387014,
  usage: 738230,
  limitUsage: 260541,
  validations: 178915,
  lastValidatedAt: new Date("2025-07-11T20:54:23.054Z"),
  expiresAt: new Date("2025-09-29T22:44:12.638Z"),
};
```
