...
let value: ValidatedLicenseKey = {
  ...
  customer: {
    ...
    deletedAt: new Date("2025-06-12T09:40:53.789Z"),
  ...
  displayKey: "<value>",
  status: "disabled",
  limitActivations: 38570,
  usage: 102011,
  limitUsage: 284506,
  validations: 873881,
  lastValidatedAt: new Date("2024-02-23T19:28:20.007Z"),
  expiresAt: new Date("2023-02-22T06:18:22.739Z"),
};
```
