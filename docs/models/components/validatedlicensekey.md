...
let value: ValidatedLicenseKey = {
  ...
  user: {
    id: "<value>",
    email: "Tara.Green@yahoo.com",
    publicName: "<value>",
  },
  customer: {
    createdAt: new Date("2025-01-08T18:32:25.623Z"),
    modifiedAt: new Date("2025-12-01T13:32:00.955Z"),
    id: "<value>",
    metadata: {
      "key": false,
    },
    email: "Alvis4@yahoo.com",
    emailVerified: false,
    name: "<value>",
    billingAddress: {
      country: "Austria",
  ...
  displayKey: "<value>",
  status: "disabled",
  limitActivations: 904021,
  usage: 165697,
  limitUsage: 278977,
  validations: 472729,
  lastValidatedAt: new Date("2023-05-04T17:14:22.025Z"),
  expiresAt: new Date("2024-02-28T15:29:51.757Z"),
};
```
