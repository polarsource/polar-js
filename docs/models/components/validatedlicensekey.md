...
let value: ValidatedLicenseKey = {
  ...
  user: {
    id: "<value>",
    email: "Roselyn_Altenwerth40@yahoo.com",
    publicName: "<value>",
  },
  customer: {
  ...
  displayKey: "<value>",
  status: "disabled",
  limitActivations: 391915,
  usage: 763739,
  limitUsage: 654240,
  validations: 420961,
  lastValidatedAt: new Date("2023-02-23T15:09:30.145Z"),
  expiresAt: new Date("2024-03-24T17:37:09.177Z"),
};
```
