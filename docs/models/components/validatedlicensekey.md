...
let value: ValidatedLicenseKey = {
  ...
  customer: {
    createdAt: new Date("2024-04-05T00:36:00.465Z"),
    modifiedAt: new Date("2024-12-24T13:54:38.176Z"),
    id: "<value>",
    metadata: {
      "key": false,
    },
  ...
  limitUsage: 197014,
  validations: 568613,
  lastValidatedAt: new Date("2025-10-17T09:25:29.798Z"),
  expiresAt: new Date("2024-09-10T16:25:42.110Z"),
};
```
