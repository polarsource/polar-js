...
let value: ValidatedLicenseKey = {
  ...
  customer: {
    ...
    deletedAt: new Date("2025-07-14T10:56:14.102Z"),
  ...
  displayKey: "<value>",
  status: "revoked",
  limitActivations: 982407,
  usage: 198849,
  limitUsage: 879491,
  validations: 271087,
  lastValidatedAt: new Date("2024-08-31T14:59:53.090Z"),
  expiresAt: new Date("2023-05-12T07:56:32.106Z"),
};
```
