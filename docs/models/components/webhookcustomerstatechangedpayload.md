...
let value: WebhookCustomerStateChangedPayload = {
  data: {
    ...
    createdAt: new Date("2024-09-15T22:31:23.316Z"),
    modifiedAt: new Date("2024-07-15T05:46:16.146Z"),
    metadata: {
      "key": false,
    },
    externalId: "usr_1337",
    ...
    activeSubscriptions: [
      {
        ...
        createdAt: new Date("2024-08-31T14:27:22.330Z"),
        modifiedAt: new Date("2024-03-09T14:44:52.776Z"),
        metadata: {
          "key": false,
        },
        amount: 1000,
    ...
    grantedBenefits: [
      {
        ...
        createdAt: new Date("2023-05-11T07:59:28.486Z"),
        modifiedAt: new Date("2024-04-02T14:57:04.115Z"),
