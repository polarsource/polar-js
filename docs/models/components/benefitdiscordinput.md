...
let value: BenefitDiscordInput = {
  createdAt: new Date("2023-09-24T14:39:14.681Z"),
  modifiedAt: new Date("2022-02-11T22:59:09.682Z"),
  id: "<value>",
  description:
    "instead likewise afford truthfully around while petal forenenst",
  selectable: false,
  deletable: false,
