...
let value: OAuth2Client = {
  redirectUris: [
    "https://sour-tennis.net/",
  ],
  clientName: "<value>",
  createdAt: new Date("2024-06-06T12:50:02.652Z"),
  modifiedAt: new Date("2025-06-23T08:41:15.007Z"),
  clientId: "<id>",
  clientSecret: "<value>",
  clientIdIssuedAt: 75629,
  clientSecretExpiresAt: 254226,
};
```
