...
let value: OAuth2Client = {
  redirectUris: [
    "https://back-lobster.com",
  ],
  clientName: "<value>",
  createdAt: new Date("2023-06-07T15:45:09.680Z"),
  modifiedAt: new Date("2025-05-09T17:12:22.765Z"),
  clientId: "<id>",
  clientSecret: "<value>",
  clientIdIssuedAt: 228672,
  clientSecretExpiresAt: 93323,
};
```
