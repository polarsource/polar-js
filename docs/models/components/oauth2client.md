...
let value: OAuth2Client = {
  redirectUris: [
    "https://inborn-pupil.org/",
  ],
  clientName: "<value>",
  createdAt: new Date("2025-09-20T14:50:47.405Z"),
  modifiedAt: new Date("2023-06-03T18:10:10.891Z"),
  clientId: "<id>",
  clientSecret: "<value>",
  clientIdIssuedAt: 871790,
  clientSecretExpiresAt: 590167,
};
```
