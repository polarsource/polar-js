...
let value: OAuth2Client = {
  redirectUris: [
    "https://courageous-fundraising.net/",
  ],
  clientName: "<value>",
  createdAt: new Date("2023-11-30T12:43:32.164Z"),
  modifiedAt: new Date("2023-03-05T10:15:44.066Z"),
  clientId: "<id>",
  clientSecret: "<value>",
  clientIdIssuedAt: 378735,
  clientSecretExpiresAt: 241254,
};
```
