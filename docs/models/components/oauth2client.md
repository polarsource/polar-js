...
let value: OAuth2Client = {
  redirectUris: [
    "https://moist-status.com",
  ],
  clientName: "<value>",
  createdAt: new Date("2024-06-28T03:36:20.568Z"),
  modifiedAt: new Date("2023-12-15T09:44:39.987Z"),
  clientId: "<id>",
  clientSecret: "<value>",
  clientIdIssuedAt: 214929,
  clientSecretExpiresAt: 736906,
};
```
