...
let value: WebhookBenefitUpdatedPayload = {
  data: {
    createdAt: new Date("2024-04-27T21:01:21.314Z"),
    modifiedAt: new Date("2022-02-06T13:50:17.641Z"),
    id: "<value>",
    description:
      "depend vamoose diligently innocently ceramics plus blah likewise and gee",
    selectable: false,
    deletable: false,
