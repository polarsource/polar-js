...
let value: DiscountFixedRepeatDuration = {
  ...
  name: "<value>",
  code: "<value>",
  startsAt: new Date("2025-03-26T21:37:08.155Z"),
  endsAt: new Date("2024-12-10T04:09:29.451Z"),
  maxRedemptions: 455640,
  redemptionsCount: 464806,
  organizationId: "<value>",
  products: [
    {
      createdAt: new Date("2023-11-24T02:16:01.160Z"),
      modifiedAt: new Date("2023-10-19T05:37:10.667Z"),
      id: "<value>",
      name: "<value>",
      description:
