...
let value: DiscountFixedRepeatDuration = {
  ...
  name: "<value>",
  code: "<value>",
  startsAt: new Date("2023-01-25T17:10:29.427Z"),
  endsAt: new Date("2024-06-26T19:14:57.655Z"),
  maxRedemptions: 72741,
  redemptionsCount: 145952,
  organizationId: "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
  products: [
    {
      createdAt: new Date("2024-05-24T23:05:32.713Z"),
      modifiedAt: new Date("2023-08-15T18:14:34.029Z"),
      id: "<value>",
      name: "<value>",
      description:
        "ramp accelerator sun pfft propound whine orderly shimmering",
