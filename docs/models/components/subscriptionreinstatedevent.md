...
```typescript
import { SubscriptionReinstatedEvent } from "@polar-sh/sdk/models/components/subscriptionreinstatedevent.js";

let value: SubscriptionReinstatedEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.reinstated"*                                                                                                    | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionReinstatedMetadata](../../models/components/subscriptionreinstatedmetadata.md)                         | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |