...
let value: BenefitBase = {
  createdAt: new Date("2024-09-03T02:28:42.833Z"),
  modifiedAt: new Date("2024-07-11T08:26:05.601Z"),
  id: "<value>",
  type: "custom",
  description: "gah punctually midst gee supposing fooey snow pace illustrious",
  selectable: false,
  deletable: false,
