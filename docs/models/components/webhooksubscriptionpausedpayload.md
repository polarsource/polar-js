...
```typescript
import { WebhookSubscriptionPausedPayload } from "@polar-sh/sdk/models/components/webhooksubscriptionpausedpayload.js";

let value: WebhookSubscriptionPausedPayload = {
  type: "subscription.paused",
  timestamp: new Date("2024-12-08T16:03:15.770Z"),
  data: {
...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `type`                                                                                        | *"subscription.paused"*                                                                       | :heavy_check_mark:                                                                            | N/A                                                                                           | subscription.paused                                                                           |
