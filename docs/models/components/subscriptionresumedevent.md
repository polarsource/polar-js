...
```typescript
import { SubscriptionResumedEvent } from "@polar-sh/sdk/models/components/subscriptionresumedevent.js";

let value: SubscriptionResumedEvent = {
  id: "<value>",
...
| `name`                                                                                                                         | *"subscription.resumed"*                                                                                                       | :heavy_check_mark:                                                                                                             | The name of the event.                                                                                                         |                                                                                                                                |
| `metadata`                                                                                                                     | [components.SubscriptionResumedMetadata](../../models/components/subscriptionresumedmetadata.md)                               | :heavy_check_mark:                                                                                                             | N/A                                                                                                                            |                                                                                                                                |