...
let value: CheckoutLegacy = {
  ...
  customerName: "<value>",
  product: {
    createdAt: new Date("2022-07-30T06:16:46.899Z"),
    modifiedAt: new Date("2023-01-08T22:15:44.580Z"),
    id: "<value>",
    name: "<value>",
    ...
    prices: [
      {
        createdAt: new Date("2022-07-06T14:18:27.483Z"),
        modifiedAt: new Date("2022-05-13T12:52:00.880Z"),
        id: "<value>",
        isArchived: false,
        productId: "<value>",
        priceCurrency: "<value>",
    ...
    benefits: [
      {
        createdAt: new Date("2023-08-15T12:09:16.429Z"),
        modifiedAt: new Date("2024-05-01T18:15:09.156Z"),
        id: "<value>",
        type: "ads",
        description:
    ...
    medias: [
      {
        ...
        lastModifiedAt: new Date("2023-11-21T22:00:18.063Z"),
        version: "<value>",
        isUploaded: false,
  ...
  productPrice: {
    createdAt: new Date("2023-09-20T09:06:06.239Z"),
    modifiedAt: new Date("2024-06-03T18:58:37.464Z"),
    id: "<value>",
    isArchived: false,
    productId: "<value>",
  },
