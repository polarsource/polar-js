...
let value: DiscountFixedOnceForeverDuration = {
  ...
  createdAt: new Date("2023-10-09T03:14:12.239Z"),
  modifiedAt: new Date("2022-01-06T02:19:06.964Z"),
  id: "<value>",
  metadata: {
    "key": false,
  },
  name: "<value>",
  code: "<value>",
  startsAt: new Date("2022-01-18T02:38:56.289Z"),
  endsAt: new Date("2024-11-10T16:10:27.514Z"),
  maxRedemptions: 513810,
  redemptionsCount: 908092,
