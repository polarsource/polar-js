...
let value: DiscountFixedOnceForeverDuration = {
  ...
  name: "<value>",
  code: "<value>",
  startsAt: new Date("2023-03-18T03:00:38.903Z"),
  endsAt: new Date("2023-10-21T14:08:24.521Z"),
  maxRedemptions: 973264,
  redemptionsCount: 81673,
  organizationId: "<value>",
  products: [
    {
      createdAt: new Date("2024-08-12T15:17:55.507Z"),
      modifiedAt: new Date("2025-10-06T06:16:48.745Z"),
      id: "<value>",
      name: "<value>",
      description: "crystallize fine times",
      isRecurring: false,
      isArchived: false,
      organizationId: "<value>",
    },
